  ...
  onMount(async () => {
    ...
    if (supabase) {
      try {
        ...
        console.log('Supabase connection test result:', debugInfo.connectionTest);
      } catch (err) {
        debugInfo.connectionTest = {
          success: false,
          error: err.message,
...
<svelte:head>
  <title>Supabase Debug - Seller Portal</title>
</svelte:head>

<div class="min-h-screen bg-gray-50 p-8">
  <div class="max-w-4xl mx-auto">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Supabase Debug Information</h1>
    ...
    <div class="bg-white rounded-lg shadow p-6">
      ...
      <div class="space-y-2">
        <a href="/test-login" class="block text-blue-600 hover:text-blue-800">→ Test Login</a>
        <a href="/auth/login" class="block text-blue-600 hover:text-blue-800">→ Normal Login</a>
