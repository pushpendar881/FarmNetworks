      ...
      <form class="mt-8 space-y-6" on:submit|preventDefault={handleSubmit}>
          <div class="space-y-4">
              ...
              <div class="flex items-center justify-between">
                  ...
                  <div class="text-sm">
                      <a href="/auth/forgot-password" class="font-medium text-green-600 hover:text-green-500">
                  ...
                  <div class="flex">
                      <div class="flex-shrink-0">
                          <svg class="h-5 w-5 text-red-400" fill="currentColor" viewBox="0 0 20 20">
                              <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L10 10.414l2.707-2.707a1 1 0 111.414 1.414L11.414 12l2.707 2.707a1 1 0 01-1.414 1.414L10 13.414l-2.707 2.707a1 1 0 01-1.414-1.414L8.586 12 5.879 9.293a1 1 0 011.414-1.414L10 10.586l2.707-2.707z" clip-rule="evenodd" />
                          </svg>
                      </div>
                      <div class="ml-3">
