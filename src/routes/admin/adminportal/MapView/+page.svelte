<script>
  ...
  // Fetch all gateways for admin view
  ...
  function initializeMap() {
    ...
    if (typeof window !== 'undefined' && window.L && mapContainer) {
      try {
        ...
        let defaultCenter = [19.2686, 73.9472]; // Default center of India
      ...
      const marker = L.marker([lat, lng], { icon: gatewayIcon })
        .bindPopup(`
          <div class="popup-content">
            ...
            <p><strong>Coverage:</strong> ${gateway.coverage_radius}m radius</p>
          </div>
        `)
        .addTo(map);
      ...
      L.marker([lat, lng], { icon: deviceIcon })
        .bindPopup(`
          <div class="popup-content">
            ...
            <p><strong>Farm:</strong> ${device.farm_name || 'Unknown'}</p>
...
animationFrame = requestAnimationFrame(animateDotPulse);
  ...
  onMount(async () => {
    console.log('Admin Map component mounted');
...
<div class="dashboard-content">
  ...
  <div class="stats-grid">
    ...
    <div class="stat-card">
      ...
      <div class="stat-info">
        ...
        <div class="stat-detail">System Connectivity</div>
      </div>
    </div>
  </div>
  ...
  <div class="map-section">
     <div class="section-header"> 
      <h3 class="section-title">System Device Locations</h3>
            ...
            {#each selectedGateway.devices as device}
              <div class="device-card">
                ...
                <div class="device-details">
                  ...
                  <div class="detail-row">
                    <span>Farm:</span>
                    <span>{device.farm_name || 'Unknown'}</span>
                  </div>
                  <div class="detail-row">
                  ...
                  <div class="detail-row">
                    <span>Runtime:</span>
                    <span>{device.runtime || 0} hours</span>
                  </div>
                </div>
              </div>
            {/each}
